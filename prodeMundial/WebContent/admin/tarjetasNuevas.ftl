								...
								<td colspan="2">
									<table class="clsLista">
										<tr>
											...
											<td><@show.label key="admin.tarjetasNuevas.cliente.tarjetasNuevas"/></td>
										</tr>
										<#list clientes as cliente>
											<#if cliente.tarjetasNuevas gt 0 >
												<tr>
													...
													<td align="right">${cliente.tarjetasNuevas?c}</td>
												</tr>
											</#if>
										</#list>
									</table>
						...
						<tr>
							<td colspan="2">
								<table class="clsBotonera">
									<tr>
										<#if ( (clientes?size)?? && clientes?size > 0 ) >
											<td><@show.button key="admin.tarjetasNuevas.button.generar" id="btnGenerar"/></td>
											<td>&nbsp;&nbsp;&nbsp;</td>
										</#if>
