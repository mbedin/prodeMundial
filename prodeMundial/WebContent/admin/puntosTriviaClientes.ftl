		...
		<table width="760" height="500" cellspacing="0" cellpadding="0" border="0">
			<tr valign="top">
				<td>
					<table>
						<tr>
							<td colspan="2" class="clsTitulo"><@show.label key="admin.puntosTriviaClientes.titulo"/></td>
						</tr>
						<tr>
							<td colspan="2">
						...
						<tr>
							<td colspan="2">
								<table border="0">
									<tr>
										<td valign="top"><@show.button key="admin.button.exportar" id="btnPuntosTriviaClientesExcel"/></td>
										<td>&nbsp;&nbsp;&nbsp;</td>
