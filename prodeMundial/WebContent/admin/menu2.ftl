			...
			<tr valign="top" height="450">
				<td class="menu">
					<ul>
						...
						<@show.menuOption key="admin.menu.tarjetasProductor" id="btnTarjetasProductor"/>
						<@show.menuOption key="admin.menu.sinTarjetas" id="btnSinTarjetas"/>
						<@show.menuOption key="admin.menu.promociones" id="btnPromociones"/>
