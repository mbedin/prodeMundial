		...
		<table width="760" height="500" cellspacing="0" cellpadding="0" border="0">
			<tr valign="top">
				<td>
					<table>
						<tr valign="top">
							<td colspan="2" class="clsTitulo"><@show.label key="admin.tarjetasNuevasOctavos.titulo"/><br><br></td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="2">
								<table class="clsBotonera">
									<tr>
										<#if ( (clientes?size)?? && clientes?size > 0 ) >
											<td><@show.button key="admin.tarjetasNuevas.button.generar" id="btnGenerar8"/></td>
											<td>&nbsp;&nbsp;&nbsp;</td>
										</#if>
