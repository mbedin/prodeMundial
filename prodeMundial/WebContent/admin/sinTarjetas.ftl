		...
		<table width="760" height="500" cellspacing="0" cellpadding="0" border="0">
			<tr valign="top">
				<td>
					<table>
						<tr valign="top">
							<td colspan="2" class="clsTitulo"><@show.label key="admin.sinTarjetas.titulo"/><br><br></td>
						</tr>
						<tr>
							<#if ( (clientes?size)?? && clientes?size > 0 ) >
								<td colspan="2">
									<table class="clsLista">
										<tr>
											<td>&nbsp;</td>
											<td><@show.label key="admin.sinTarjetas.cliente.nombre"/></td>
										</tr>
							...
							<#else>
								<td colspan="2" class="txTahomaNgr11b">
									<@show.label key="admin.sinTarjetas.empty"/>
								</td>
							</#if>
						</tr>
						<tr>
							<td colspan="2">
								<table class="clsBotonera">
									<tr>
										<#if ( (clientes?size)?? && clientes?size > 0 ) >
											<td><@show.button key="admin.sinTarjetas.button.generar" id="btnGenerarSinTarjetas"/></td>
											<td>&nbsp;&nbsp;&nbsp;</td>
										</#if>
