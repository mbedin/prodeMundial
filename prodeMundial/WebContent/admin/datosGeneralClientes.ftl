					...
					<table>
							...
							<td colspan="2">
								<table class="clsLista">
									<tr>
										...
										<td><@show.label key="admin.cliente.razonSocial"/></td>
										<td><@show.label key="admin.cliente.aceptoBases"/></td>
										<td><@show.label key="admin.cliente.totalTarjetas"/></td>
										<td><@show.label key="admin.cliente.tarjetasJugadas"/></td>
										<td><@show.label key="admin.cliente.tarjetasPorJugar"/></td>
									...
									<#list clientes as cliente>
										<tr>
											...
											<td align="center">${cliente.tarjetasAnterior?c}</td>
											<td align="center">${cliente.tarjetasExtrasAnterior?c}</td>
											<td align="center">${cliente.tarjetasExtras?c}</td>
											<td align="center">${cliente.tarjetas?c}</td>
										</tr>
									</#list>
								</table>
							</td>
						...
						<tr>
							<td colspan="2">
								<table border="0">
									<tr>
										<td valign="top"><@show.button key="admin.button.exportar" id="btnReporteGeneralClientesExcel"/></td>
										<td>&nbsp;&nbsp;&nbsp;</td>
