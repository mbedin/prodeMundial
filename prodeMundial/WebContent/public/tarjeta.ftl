					...
					<table border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td width="240" align="right">
								<#if (!readOnly)>
									<a href="#" id="btnAceptar"><img src="img/bo_cargartarjeta.gif" width="113" height="31" alt="" border="0"></a>
								<#else>
									<#if (cargaHabilitada)>
										<a href="#" id="btnModificar"><img src="img/bo_modificartarjeta.gif" width="113" height="31" alt="" border="0"></a>
									<#else>
										<img src="img/punto.gif" width="31" height="31" alt="" border="0">
									</#if>
								</#if>
							</td>
				...
				<td valign="top">
					<table border="0" cellspacing="0" cellpadding="0" align="center">
						...
						<#if tarjeta.tarjetaProductor>
							<tr>
								<td><img src="img/punto.gif" width="16" height="17" alt="" border="0"></td>
								<td width="724" valign="top" align="center" colspan="3">
									<#include "productor.ftl" />
								</td>
								<td><img src="img/punto.gif" width="16" height="17" alt="" border="0"></td>
							</tr>
							...
							<tr>
								<td><img src="img/punto.gif" width="16" height="17" alt="" border="0"></td>
								<td width="354" valign="top" align="center">&nbsp;</td>
								<td><img src="img/punto.gif" width="16" height="17" alt="" border="0"></td>
