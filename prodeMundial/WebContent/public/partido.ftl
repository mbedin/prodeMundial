				...
				<td class="tableGrupos">
					<table border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="140" class="clsTxArialBlc10" align="right">&nbsp;<#if ((i%2)==0)>${grupo.descripcion} - </#if>${partido.fecha?string("dd/MM")} - ${partido.hora?string("HH:mm")} hs.</td>
							<td width="1" bgcolor="#FFFFFF"><img src="img/punto.gif" width="1" height="1" alt="" border="0"></td>
				...
				<td height="22" valign="middle">
					<table border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="1" bgcolor="#FFFFFF"><img src="img/punto.gif" width="1" height="1" alt="" border="0"></td>
							<td width="18" class="clsTxArialBlc7" align="center">
								<@show.checkboxEspecial name="parEmpate_${pronosticoPartido.id?c}" id="parEmpate_${pronosticoPartido.id?c}" value="true" checked="${pronosticoPartido.esEmpate?string}" disabled=false onclick="javascript: chkLEV_click(this);" cssClass="radioButtons2" disabled="${readOnly?string}"/>								
							</td>
							<td width="1" bgcolor="#FFFFFF"><img src="img/punto.gif" width="1" height="1" alt="" border="0"></td>
