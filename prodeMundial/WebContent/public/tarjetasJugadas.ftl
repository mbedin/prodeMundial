...
<@show.page image="img/bg_tarjetasjugadas.jpg">
	<form name="frmMain" id="frmMain" method="post">
		...
		<input type="hidden" name="paginador.accion" id="paginador_accion" value="${paginador.accion}" />
	 	...
	 	<table height="538" width="760" border="0" cellspacing="0" cellpadding="0" align="center" background="img/bg_tarjetasjugadas.jpg">
			<tr>
				<td colspan="2" height="40" valign="top">
					<table border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td colspan="2" class="clsTxArialNar16"><@show.label key="tarjetasJugadas.titulo"/></td>
						</tr>
					</table>
				</td>
			</tr>
				...
				<td valign="top" width="622">
					<table border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<#if ( (tarjetasJugadas?size)?? && tarjetasJugadas?size > 0 ) >
								<#list tarjetasJugadas as tarjeta>
							...
							<#else>
								<@show.label key="tarjetasJugadas.empty"/>
							</#if>
							</td>
						</tr>
