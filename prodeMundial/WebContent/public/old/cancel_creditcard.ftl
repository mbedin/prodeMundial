...
<form name="frmMain" id="frmMain" method="post">
	<table width="735" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td colspan="3" height="32" class="txTahomaAzl24"><img src="img/bu_titulo.gif" width="17" height="17" alt="" border="0">&nbsp;<@show.invtrLabel key="cancelledCC.Title.CancelledApplication"/></td>
				</tr>
				<tr>
						...
						<table width="735" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td class="txTahomaGrs11">
									<@show.invtrLabel key="cancelledCC.Text.unableToProcess"/>
									<br><br>
									<@show.invtrLabel key="cancelledCC.Text.SecurityReasons"/>
									<br><br>
									<@show.invtrLabel key="cancelledCC.Text.restartApplication"/>									
									<br><br><br>
									<@show.invtrLabel key="cancelledCC.Text.Thankyou"/>
									<br><br><br>
									<@show.invtrLabel key="cancelledCC.Text.InvestorsTrust"/>
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td>
									<table border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td>
												<@show.invtrButton key="cancelledCC.Button.Close" id="btnClose" arrowLeft="0" arrowRight="0"/>
											</td>
